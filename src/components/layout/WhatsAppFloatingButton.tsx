...
/**
 * Glifo do WhatsApp em SVG. Os Material Symbols, usados no resto do site,
 * não incluem logótipos de marcas — o ícone anterior era um balão de
 * conversa genérico, que não identificava o serviço.
 */

  ...
  return (
    <form action={formAction} className="max-w-2xl space-y-6">
      ...
      <TextField
        ...
        defaultValue={section?.iconName ?? ""}
        placeholder="ex: verified"
      />
      <LocaleTabs
        pt={
          <>
            <TextField id="eyebrowPt" name="eyebrowPt" label="Eyebrow (PT)" defaultValue={pt?.eyebrow ?? ""} />
        ...
        en={
          <>
            <TextField id="eyebrowEn" name="eyebrowEn" label="Eyebrow (EN)" defaultValue={en?.eyebrow ?? ""} />

...
// not set as a Service's "Botão de Ação") won't be shown anywhere — the
// dropdown below steers editors towards a slot that's guaranteed to work.
...
export function CtaForm({ cta, existingKeys = [], action }: CtaFormProps) {
  ...
  function handleKeySelectChange(e: FormEvent<HTMLSelectElement>) {
    setCustomKey(e.currentTarget.value === "__custom__");
  }
